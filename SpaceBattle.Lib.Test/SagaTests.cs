...
public class SagaTests
{
    ...
    public void executeSagaSuccessTest()
    {
        ...
        IoC.Resolve<Hwdtech.ICommand>("IoC.Register", "Commands.Undo.MoveCommand", (object[] args) => new MoveCommand(mockIMAdapter.Object)).Execute();
        IoC.Resolve<Hwdtech.ICommand>("IoC.Register", "Commands.Undo.WasteFuelCommand", (object[] args) => new WasteFuelCommand(mockIWAdapter.Object)).Execute();
